                    ...
                    int *mouses, int *baterias, int *chips, int *tarjetagrafica, int opcionproducto, int cantidadpedido, int respuestaRP)
{
    ...
    while (respuestaRP == 1)
    {
        ...
        case 0: // Producto 1 (Laptop)
            printf("Se necesito %d pantalla, %d teclados, %d mouses, %d baterias, %d chips y %d tarjetas grafica.\n", cantidadpedido, cantidadpedido, cantidadpedido, cantidadpedido, cantidadpedido, cantidadpedido);
        ...
        case 1: // Producto 2 (Celulares)
            printf("Se necesito %d pantalla, %d baterias, %d chips.\n", cantidadpedido, cantidadpedido, cantidadpedido);
        ...
        case 3: // Producto 4 (Smartwatches)
            printf("Se necesito %d baterias, %d chips.\n", cantidadpedido, cantidadpedido);
        ...
        case 4: // Producto 5 (Gafas VR)
            printf("Se necesito %d pantallas, %d chips y %d tarjetas graficas.\n", cantidadpedido, cantidadpedido, cantidadpedido);
                     ...
                     int *baterias, int *chips, int *tarjetagrafica, int *contador)
{
    ...
    else
    {
        if (*contador < 5)
        {
            ...
            scanf("%d", &nuevoMouse);
            printf("Ingrese la cantidad de baterias para %s: ", nuevoProducto);
            scanf("%d", &nuevaBateria);
            printf("Ingrese la cantidad de chips para %s: ", nuevoProducto);
            scanf("%d", &nuevoChip);
            printf("Ingrese la cantidad de tarjetas graficas para %s: ", nuevoProducto);
            ...
            // Sumar al inventario
            *pantallas += nuevaPantalla;
            *teclados += nuevoTeclado;
            *mouses += nuevoMouse;
            *baterias += nuevaBateria;
            *chips += nuevoChip;
            *tarjetagrafica += nuevaTarjeta;
            (*contador)++;
